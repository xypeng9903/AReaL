...
if __name__ == "__main__":
    ...
    data_path = "/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/pengxinyu05/opd-baselines/limit-of-RLVR/math/examples/math_eval/data/aime24/test.jsonl"
    
    tokenizer = load_hf_tokenizer(tokenizer_path)
    dataset = get_jsonl_rl_dataset(data_path, tokenizer)
